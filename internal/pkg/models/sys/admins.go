...
type Admins struct {
	...
	Salt      string    `gorm:"column:salt;type:char(8);not null;" json:"-" form:"salt"`                                               // 密码(盐)
	...
	UpdatedAt time.Time `gorm:"column:updated_at;type:datetime;not null;" json:"-" form:"updated_at"`                                  // 更新时间
}
